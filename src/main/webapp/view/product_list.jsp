...
<html lang="en">
  <head>
    ...
    <!-- Simple bar CSS -->
    <link rel="stylesheet" href="view/css/simplebar.css">
    <!-- Fonts CSS -->
    <link href="https://fonts.googleapis.com/css2?family=Overpass:ital,wght@0,100;0,200;0,300;0,400;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
    <!-- Icons CSS -->
    <link rel="stylesheet" href="view/css/feather.css">
    <!-- Date Range Picker CSS -->
    <link rel="stylesheet" href="view/css/daterangepicker.css">
    <!-- App CSS -->
    <link rel="stylesheet" href="view/css/app-light.css" id="lightTheme" disabled>
    <link rel="stylesheet" href="view/css/app-dark.css" id="darkTheme">
  </head>
    ...
    <div class="wrapper">
      <nav class="topnav navbar navbar-light">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link text-muted my-2" href="js#" data-toggle="modal" data-target=".modal-shortcut">
              <span class="fe fe-grid fe-16"></span>
            </a>
          </li>
          <li class="nav-item nav-notif">
            <a class="nav-link text-muted my-2" href="js#" data-toggle="modal" data-target=".modal-notif">
                    ...
                    <form>
                      <table class="table table-borderless table-hover">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="avatar avatar-sm">
                              <img src="view/assets/avatars/face-3.jpg" alt="..." class="avatar-img rounded-circle">
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="avatar avatar-sm">
                              <img src="view/assets/avatars/face-2.jpg" alt="..." class="avatar-img rounded-circle">
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="avatar avatar-sm">
                              <img src="view/assets/avatars/face-4.jpg" alt="..." class="avatar-img rounded-circle">
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="avatar avatar-sm">
                              <img src="view/assets/avatars/face-5.jpg" alt="..." class="avatar-img rounded-circle">
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="avatar avatar-sm">
                              <img src="view/assets/avatars/face-6.jpg" alt="..." class="avatar-img rounded-circle">
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="avatar avatar-sm">
                              <img src="view/assets/avatars/face-7.jpg" alt="..." class="avatar-img rounded-circle">
                            </div>
                          </td>
                          <td>
