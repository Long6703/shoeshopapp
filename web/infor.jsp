                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <ul class="user-profile-list" style="margin-bottom: 30px">
                                            <li><span>Full Name:</span><input type="text" name="fname" value="${UserTemp.fullname}" style="width: 700px"/></li>
                                            <li><span>Address:</span><input type="text" name="address" value="${UserTemp.address}" style="width: 700px"/></li>
                                            <li><span>Date of birth:</span><input type="date" name="dob" value="${UserTemp.dob}" style="width: 700px"/></li>
                                            <li><span>Gender:</span>
                                                <select name="gender" required="">
                                                    <option value="male" ${UserTemp.gender != null && UserTemp.gender ? 'selected' : '' }>Male</option>
                                                    <option value="female" ${UserTemp.gender != null && !UserTemp.gender ? 'selected' : '' }>Female</option>
                                                </select>
                                            </li>
                                            <li><span>Email</span><input type="text" name="email" value="${UserTemp.email}" readonly style="width: 700px" /></li>
                                            <li><span>Phone:</span><input type="text" name="phone" value="${UserTemp.phone}" style="width: 700px"/></li>
                                        </ul>
                                        <div class="col-md-6">
                                            <button type="submit" class="btn btn-main btn-large btn-round-full">Save</button>
                                        </div>
                                        <div class="col-md-6">
                                            <button type="reset" class="btn btn-main btn-large btn-round-full">Cancel</button>
                                        </div>
                                    </div>
